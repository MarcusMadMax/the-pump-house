...
<section id="about">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="section-title mx-auto">About us</h3>
    ...
    <div class="container about-container wow fadeInUp">
        <div class="row">
            <div class="col-lg-6 mb-md-5 about-img">
                <img src="<?php echo get_template_directory_uri()?>/assets/img/the-pump-house/The-Pumphouse-Theatre.jpg" alt="The Pump House from the lake">
            </div>
